...
import os
import tempfile
from eigenpairflow import track_eigenvalue_decomposition, create_n_partite_graph, EigenTrackingResults
...
def test_eigen_tracking_results_serialization():
    ...
    results = track_eigenvalue_decomposition(G, apply_correction=False)
